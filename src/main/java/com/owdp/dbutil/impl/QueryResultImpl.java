...
import com.owdp.dbutil.util.TypeUtils;
import ognl.Ognl;
...
public final class QueryResultImpl implements QueryResult,Serializable {
    ...
    private static void ensureAfterInstance(Object value){
        //保证AfterInstance方法被执行
        if(value != null){
            try {
                Meta meta = Meta.parse(value.getClass());
    ...
    private static final class QueryResultItemImpl implements QueryResultItem,Serializable{
